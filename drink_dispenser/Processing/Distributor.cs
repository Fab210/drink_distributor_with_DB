...
namespace drink_distributor.Processing
{
    class Distributor
    {
        ...
        static CoinModel coin1C = new CoinModel(CoinList[0].coinValue, CoinList[0].coinQuantity);
        static CoinModel coin2C = new CoinModel(CoinList[1].coinValue, CoinList[1].coinQuantity);
        static CoinModel coin5C = new CoinModel(CoinList[2].coinValue, CoinList[2].coinQuantity);
        static CoinModel coin10C = new CoinModel(CoinList[3].coinValue, CoinList[3].coinQuantity);
        static CoinModel coin20C = new CoinModel(CoinList[4].coinValue, CoinList[4].coinQuantity);
        static CoinModel coin50C = new CoinModel(CoinList[5].coinValue, CoinList[5].coinQuantity);
        static CoinModel coin1Eur = new CoinModel(CoinList[6].coinValue, CoinList[6].coinQuantity);
        static CoinModel coin2Eur = new CoinModel(CoinList[7].coinValue, CoinList[7].coinQuantity);
        ...
        public void SelectDrink()
        {
            ...
            Console.WriteLine("1 : " + coca.itemName);
            Console.WriteLine("2 : " + fanta.itemName);
            Console.WriteLine("3 : " + sprite.itemName);
            Console.WriteLine();
           ...
           switch (selectedDrink_num)
           {
               case 1:
                   Console.WriteLine();
                   Console.WriteLine("You selected " + coca.itemName);
                   PayDrink(1);
                   break;
               case 2:
                   Console.WriteLine();
                   Console.WriteLine("You selected " + fanta.itemName);
                   PayDrink(2);
                   break;
               case 3:
                   Console.WriteLine();
                   Console.WriteLine("You selected " + sprite.itemName);
                   PayDrink(3);
                   break;
               default:
                   Console.WriteLine();
